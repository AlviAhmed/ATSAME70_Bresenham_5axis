...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=examples/driver_examples.c hal/src/hal_atomic.c hal/src/hal_delay.c hal/src/hal_gpio.c hal/src/hal_init.c hal/src/hal_io.c hal/src/hal_sleep.c hal/src/hal_pwm.c hal/utils/src/utils_assert.c hal/utils/src/utils_event.c hal/utils/src/utils_list.c hal/utils/src/utils_syscalls.c hpl/core/hpl_core_m7_base.c hpl/core/hpl_init.c hpl/pmc/hpl_pmc.c hpl/pmc/hpl_sleep.c hpl/pwm/hpl_pwm.c hpl/xdmac/hpl_xdmac.c same70b/gcc/gcc/startup_same70q21b.c same70b/gcc/system_same70q21b.c led_flasher_main.c driver_init.c atmel_start.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/examples/driver_examples.o ${OBJECTDIR}/hal/src/hal_atomic.o ${OBJECTDIR}/hal/src/hal_delay.o ${OBJECTDIR}/hal/src/hal_gpio.o ${OBJECTDIR}/hal/src/hal_init.o ${OBJECTDIR}/hal/src/hal_io.o ${OBJECTDIR}/hal/src/hal_sleep.o ${OBJECTDIR}/hal/src/hal_pwm.o ${OBJECTDIR}/hal/utils/src/utils_assert.o ${OBJECTDIR}/hal/utils/src/utils_event.o ${OBJECTDIR}/hal/utils/src/utils_list.o ${OBJECTDIR}/hal/utils/src/utils_syscalls.o ${OBJECTDIR}/hpl/core/hpl_core_m7_base.o ${OBJECTDIR}/hpl/core/hpl_init.o ${OBJECTDIR}/hpl/pmc/hpl_pmc.o ${OBJECTDIR}/hpl/pmc/hpl_sleep.o ${OBJECTDIR}/hpl/pwm/hpl_pwm.o ${OBJECTDIR}/hpl/xdmac/hpl_xdmac.o ${OBJECTDIR}/same70b/gcc/gcc/startup_same70q21b.o ${OBJECTDIR}/same70b/gcc/system_same70q21b.o ${OBJECTDIR}/led_flasher_main.o ${OBJECTDIR}/driver_init.o ${OBJECTDIR}/atmel_start.o
POSSIBLE_DEPFILES=${OBJECTDIR}/examples/driver_examples.o.d ${OBJECTDIR}/hal/src/hal_atomic.o.d ${OBJECTDIR}/hal/src/hal_delay.o.d ${OBJECTDIR}/hal/src/hal_gpio.o.d ${OBJECTDIR}/hal/src/hal_init.o.d ${OBJECTDIR}/hal/src/hal_io.o.d ${OBJECTDIR}/hal/src/hal_sleep.o.d ${OBJECTDIR}/hal/src/hal_pwm.o.d ${OBJECTDIR}/hal/utils/src/utils_assert.o.d ${OBJECTDIR}/hal/utils/src/utils_event.o.d ${OBJECTDIR}/hal/utils/src/utils_list.o.d ${OBJECTDIR}/hal/utils/src/utils_syscalls.o.d ${OBJECTDIR}/hpl/core/hpl_core_m7_base.o.d ${OBJECTDIR}/hpl/core/hpl_init.o.d ${OBJECTDIR}/hpl/pmc/hpl_pmc.o.d ${OBJECTDIR}/hpl/pmc/hpl_sleep.o.d ${OBJECTDIR}/hpl/pwm/hpl_pwm.o.d ${OBJECTDIR}/hpl/xdmac/hpl_xdmac.o.d ${OBJECTDIR}/same70b/gcc/gcc/startup_same70q21b.o.d ${OBJECTDIR}/same70b/gcc/system_same70q21b.o.d ${OBJECTDIR}/led_flasher_main.o.d ${OBJECTDIR}/driver_init.o.d ${OBJECTDIR}/atmel_start.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/examples/driver_examples.o ${OBJECTDIR}/hal/src/hal_atomic.o ${OBJECTDIR}/hal/src/hal_delay.o ${OBJECTDIR}/hal/src/hal_gpio.o ${OBJECTDIR}/hal/src/hal_init.o ${OBJECTDIR}/hal/src/hal_io.o ${OBJECTDIR}/hal/src/hal_sleep.o ${OBJECTDIR}/hal/src/hal_pwm.o ${OBJECTDIR}/hal/utils/src/utils_assert.o ${OBJECTDIR}/hal/utils/src/utils_event.o ${OBJECTDIR}/hal/utils/src/utils_list.o ${OBJECTDIR}/hal/utils/src/utils_syscalls.o ${OBJECTDIR}/hpl/core/hpl_core_m7_base.o ${OBJECTDIR}/hpl/core/hpl_init.o ${OBJECTDIR}/hpl/pmc/hpl_pmc.o ${OBJECTDIR}/hpl/pmc/hpl_sleep.o ${OBJECTDIR}/hpl/pwm/hpl_pwm.o ${OBJECTDIR}/hpl/xdmac/hpl_xdmac.o ${OBJECTDIR}/same70b/gcc/gcc/startup_same70q21b.o ${OBJECTDIR}/same70b/gcc/system_same70q21b.o ${OBJECTDIR}/led_flasher_main.o ${OBJECTDIR}/driver_init.o ${OBJECTDIR}/atmel_start.o

# Source Files
SOURCEFILES=examples/driver_examples.c hal/src/hal_atomic.c hal/src/hal_delay.c hal/src/hal_gpio.c hal/src/hal_init.c hal/src/hal_io.c hal/src/hal_sleep.c hal/src/hal_pwm.c hal/utils/src/utils_assert.c hal/utils/src/utils_event.c hal/utils/src/utils_list.c hal/utils/src/utils_syscalls.c hpl/core/hpl_core_m7_base.c hpl/core/hpl_init.c hpl/pmc/hpl_pmc.c hpl/pmc/hpl_sleep.c hpl/pwm/hpl_pwm.c hpl/xdmac/hpl_xdmac.c same70b/gcc/gcc/startup_same70q21b.c same70b/gcc/system_same70q21b.c led_flasher_main.c driver_init.c atmel_start.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Default.mk dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/examples/driver_examples.o: examples/driver_examples.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/examples/driver_examples.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/examples/driver_examples.o.d" -o ${OBJECTDIR}/examples/driver_examples.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/examples/driver_examples.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_atomic.o: hal/src/hal_atomic.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_atomic.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_atomic.o.d" -o ${OBJECTDIR}/hal/src/hal_atomic.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_atomic.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_delay.o: hal/src/hal_delay.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_delay.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_delay.o.d" -o ${OBJECTDIR}/hal/src/hal_delay.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_delay.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_gpio.o: hal/src/hal_gpio.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_gpio.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_gpio.o.d" -o ${OBJECTDIR}/hal/src/hal_gpio.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_gpio.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_init.o: hal/src/hal_init.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_init.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_init.o.d" -o ${OBJECTDIR}/hal/src/hal_init.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_init.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_io.o: hal/src/hal_io.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_io.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_io.o.d" -o ${OBJECTDIR}/hal/src/hal_io.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_io.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_sleep.o: hal/src/hal_sleep.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_sleep.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_sleep.o.d" -o ${OBJECTDIR}/hal/src/hal_sleep.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_sleep.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_pwm.o: hal/src/hal_pwm.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_pwm.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_pwm.o.d" -o ${OBJECTDIR}/hal/src/hal_pwm.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/src/hal_pwm.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/utils/src/utils_assert.o: hal/utils/src/utils_assert.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/utils/src/utils_assert.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/utils/src/utils_assert.o.d" -o ${OBJECTDIR}/hal/utils/src/utils_assert.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/utils/src/utils_assert.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/utils/src/utils_event.o: hal/utils/src/utils_event.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/utils/src/utils_event.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/utils/src/utils_event.o.d" -o ${OBJECTDIR}/hal/utils/src/utils_event.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/utils/src/utils_event.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/utils/src/utils_list.o: hal/utils/src/utils_list.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/utils/src/utils_list.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/utils/src/utils_list.o.d" -o ${OBJECTDIR}/hal/utils/src/utils_list.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/utils/src/utils_list.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/utils/src/utils_syscalls.o: hal/utils/src/utils_syscalls.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/utils/src/utils_syscalls.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/utils/src/utils_syscalls.o.d" -o ${OBJECTDIR}/hal/utils/src/utils_syscalls.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hal/utils/src/utils_syscalls.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hpl/pmc/hpl_sleep.o: hpl/pmc/hpl_sleep.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/hpl/pmc/hpl_sleep.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hpl/pmc/hpl_sleep.o.d" -o ${OBJECTDIR}/hpl/pmc/hpl_sleep.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hpl/pmc/hpl_sleep.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/hpl/pwm/hpl_pwm.o: hpl/pwm/hpl_pwm.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/hpl/pwm" 
	@${RM} ${OBJECTDIR}/hpl/pwm/hpl_pwm.o.d 
	@${RM} ${OBJECTDIR}/hpl/pwm/hpl_pwm.o 
	@${FIXDEPS} "${OBJECTDIR}/hpl/pwm/hpl_pwm.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hpl/pwm/hpl_pwm.o.d" -o ${OBJECTDIR}/hpl/pwm/hpl_pwm.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/hpl/pwm/hpl_pwm.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/examples/driver_examples.o: examples/driver_examples.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/examples/driver_examples.o.d 
	@${RM} ${OBJECTDIR}/examples/driver_examples.o 
	@${FIXDEPS} "${OBJECTDIR}/examples/driver_examples.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m7  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/pio" -I "./." -I "hpl/core" -I "examples" -I "hpl/pmc" -I "hpl/pwm" -I "hal/utils/include" -I "hal/include" -I "hpl/xdmac" -I "config" -I "hri"  -I "same70b/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/examples/driver_examples.o.d" -o ${OBJECTDIR}/examples/driver_examples.o "/home/al/Documents/Year5Sem1/ELE700/projects/actual_cnc_stuff/led_flasher_pwm.X/examples/driver_examples.c"  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=cortex-m7   -gdwarf-2  -D__$(MP_PROCESSOR_OPTION)__    -mthumb --specs=nosys.specs -Wl,-Map="dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.map"  -o dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1  -L"same70b/gcc/gcc" -Wl,--gc-sections   -T"same70b/gcc/gcc/same70q21b_flash.ld" 
...
dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=cortex-m7  -D__$(MP_PROCESSOR_OPTION)__    -mthumb --specs=nosys.specs -Wl,-Map="dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.map"  -o dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)  -L"same70b/gcc/gcc" -Wl,--gc-sections   -T"same70b/gcc/gcc/same70q21b_flash.ld" 
	
	${MP_CC_DIR}/arm-none-eabi-objcopy -O ihex -R .eeprom -R .fuse -R .lock -R .signature "dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/led_flasher_pwm.X.${IMAGE_TYPE}.hex"
